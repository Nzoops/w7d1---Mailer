...
class ParticipationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participation" do
    assert_difference("Participation.count") do
      post participations_url, params: { participation: { stripe_customer_id: @participation.stripe_customer_id } }
    end
  ...
  test "should update participation" do
    patch participation_url(@participation), params: { participation: { stripe_customer_id: @participation.stripe_customer_id } }
